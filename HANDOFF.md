...
| Unit/component tests (`npm run test`)                        | **478/478** across 46 files                                                                                                                                                                                                                                           |
| `npm run typecheck` / `npm run lint`                         | clean                                                                                                                                                                                                                                                                 |
| `npm run build` + `npm run size`                             | audience route **177.59 kB** brotli, budget 180 kB — see § 5.13 for how little room that is                                                                                                                                                                           |
