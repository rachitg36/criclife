...
| Unit/component tests (`npm run test`)                        | **433/433** across 41 files                                                                                                                                                                                                                                           |
| `npm run typecheck` / `npm run lint`                         | clean                                                                                                                                                                                                                                                                 |
| `npm run build` + `npm run size`                             | audience route **177.25 kB** brotli, budget 180 kB — see § 5.13 for how little room that is                                                                                                                                                                           |
