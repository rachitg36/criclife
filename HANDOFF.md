...
| Unit/component tests (`npm run test`)                        | **459/459** across 43 files                                                                                                                                                                                                                                           |
| `npm run typecheck` / `npm run lint`                         | clean                                                                                                                                                                                                                                                                 |
| `npm run build` + `npm run size`                             | audience route **177.60 kB** brotli, budget 180 kB — see § 5.13 for how little room that is                                                                                                                                                                           |
