...
| Unit/component tests (`npm run test`)                        | **407/407** across 36 files                                                                                                                                                                                                                                           |
| `npm run typecheck` / `npm run lint`                         | clean                                                                                                                                                                                                                                                                 |
| `npm run build` + `npm run size`                             | audience route **177.22 kB** brotli, budget 180 kB — see § 5.13 for how little room that is                                                                                                                                                                           |
