...
| Unit/component tests (`npm run test`)                        | **415/415** across 38 files                                                                                                                                                                                                                                           |
| `npm run typecheck` / `npm run lint`                         | clean                                                                                                                                                                                                                                                                 |
| `npm run build` + `npm run size`                             | audience route **177.20 kB** brotli, budget 180 kB — see § 5.13 for how little room that is                                                                                                                                                                           |
